        ...
        <main class="dashboard-main" role="main" aria-labelledby="content-title">
            ...
            <div class="content-grid" role="region" :aria-label="`Contenido de ${getSectionTitle(activeSection)}`">
                ...
                <section v-if="activeSection === 'accounts'" class="content-section"
                    ...
                    <AccountSection :showSummary="true" :totalAccounts="accounts.length"
                        :totalBalanceCRC="totalBalanceCRC" :totalBalanceUSD="totalBalanceUSD">
                        <AccountCard v-for="acc in accounts" :key="acc.account_id" :account="acc"
                            @viewDetails="handleViewDetails" @quickTransfer="handleQuickTransfer" />
                    </AccountSection>
                </section>
