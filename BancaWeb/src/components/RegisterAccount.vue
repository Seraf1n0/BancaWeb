...
const handleKeypress = (event) => {
  ...
  if (event.ctrlKey || event.metaKey || ['Backspace', 'Delete'].includes(char)) {
    return
  }
    ...
    <div class="wrap">
      <div class="radio-group">
        <span
          ...
          /><label for="option1">Nacional</label></span
        >
        <span
          ><input
            type="radio"
            ...
            value="option2"
            v-model="checkboxValue"
          /><label for="option2">DIMEX</label></span
        >
        <span
          ><input
            type="radio"
            ...
            value="option3"
            v-model="checkboxValue"
          /><label for="option3">Pasaporte</label></span
        >
      </div>
      ...
      <div v-if="identificationNumber && !isValidId" class="error-message">
        <span v-if="checkboxValue === 'option1'"
          >Cédula nacional debe tener 9 dígitos y comenzar con 1-7</span
        >
        <span v-if="checkboxValue === 'option2'"
          >DIMEX debe tener 11-12 dígitos y comenzar con 1-9</span
        >
        <span v-if="checkboxValue === 'option3'"
          >Pasaporte debe comenzar con letra mayúscula seguida de 6-12 dígitos</span
        >
      </div>

      <div v-if="isValidId" class="success-message">✓ Número de identificación válido</div>
      ...
      <div v-if="username && isValidUsername" class="success-message">El usuario es válido</div>
      ...
      <div v-if="dateBirth && isAdult" class="success-message">Eres mayor de edad.</div>
      ...
      />
      <div v-if="email && !isValidEmail" class="error-message">Correo electrónico no válido.</div>
      <div v-if="email && isValidEmail" class="success-message">Correo electrónico válido</div>
      ...
      <button type="button" @click="showTermsModal = true" class="btn-terms">
      ...
      <button type="submit" :disabled="!FormComplete" class="submit-btn">Enviar</button>
    </div>
  </form>
</template>
