...
<template>
    <div class="wrap"> 
        <form @submit.prevent="submitData" class="login-form" v-show="showUserRecuperation">
                ...
                <input v-model="username" type="text" id="username" required class="input-username" placeholder="Username">
...
.wrap {
  ...
  flex-direction: column;
  align-items: center;
  background: -webkit-linear-gradient(90deg, #0d0d0d,#0a2330,#4b495f);                         background: linear-gradient(90deg, #0d0d0d,#0a2330,#4b495f);                       
  min-height: 100vh;
}
