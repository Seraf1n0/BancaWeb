...
{
    public class GetCardMovementRepository
    {
        private readonly HttpClient _httpClient;
        private readonly string _supabaseUrl;
        private readonly string _supabaseKey;

        public GetCardMovementRepository(HttpClient httpClient, IConfiguration configuration)
        {
        ...
        {
            var url = $"{_supabaseUrl}/rest/v1/rpc/sp_card_movements_list";
            var body = new {
                p_card_id  = card_id,
            ...
            var result = JsonSerializer.Deserialize<GetListCardMovement>(responseContent);
            if (result == null)
